...
summary.trees<-trees%>%count(FarmName, VegClass, SpeciesName)%>%merge(.,summary.trees, by=c("FarmName", "VegClass", "SpeciesName"))
...
summary.shrubs<-shrubs%>%count(FarmName, VegClass, SpeciesName)%>%merge(.,summary.shrubs, by=c("FarmName", "VegClass", "SpeciesName"))
...
summary.under<-under%>%count(FarmName, VegClass, SpeciesName)%>%merge(.,summary.under, by=c("FarmName","VegClass", "SpeciesName"))
